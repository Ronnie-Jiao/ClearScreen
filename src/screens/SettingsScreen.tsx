...
const s=StyleSheet.create({scroll:{padding:18,paddingBottom:110},group:{paddingHorizontal:16,marginBottom:14},groupTitle:{height:58,textAlignVertical:'center',fontSize:20,fontWeight:'900',color:C.navy,borderBottomWidth:1,borderBottomColor:C.line},row:{minHeight:78,flexDirection:'row',alignItems:'center',gap:14,borderBottomWidth:1,borderBottomColor:C.line},rowTitle:{flex:1,fontSize:18,fontWeight:'900',color:C.navy},right:{flexDirection:'row',alignItems:'center',gap:8},good:{fontSize:17,fontWeight:'900',color:C.green},meta:{fontSize:17,fontWeight:'800',color:C.text2},segment:{flexDirection:'row',backgroundColor:'#EEF4FB',borderRadius:14,padding:3},seg:{paddingHorizontal:12,paddingVertical:8,fontWeight:'800',color:'#5E7598'},segOn:{backgroundColor:C.blue,color:'#fff',borderRadius:11,overflow:'hidden'}})
